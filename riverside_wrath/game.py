...
class GameState:
    ...
    def unleash_wrath(self):
        ...
        if self.game_over or self.wrath < 100:
            return False
        self.score += len(self.trash) * 5 + len(self.polluters) * self.POLLUTER_SCORE
    ...
    def _cleanse_trash(self):
        self.score += self.TRASH_SCORE
        self.cleansed += 1
    ...
    def _spawn_polluter(self):
        ...
        self.polluters.append({"x": x, "y": y, "side": side, "state": "in", "t": 0})
    ...
    def _toss_trash(self, p):
        ...
        self.trash.append({"x": x, "y": p["y"], "cd": self._trash_speed()})
    ...
    def _step_trash(self):
        ...
        for t in self.trash:
            ...
            if t["y"] > self.play_bottom:
                self.purity -= self.BREACH_DAMAGE
                self.breaches += 1
            else:
                kept.append(t)
        self.trash = kept
